...
('spring-petclinic', 'spring-projects',
 ...
 'src/main/java/org/springframework/samples/|├── owner/|│   ├── Owner.java|│   ├── OwnerController.java|│   └── OwnerRepository.java|├── pet/|│   ├── Pet.java|│   └── PetController.java|└── vet/|    └── VetController.java',
...
('realworld-springboot', 'gothinkster',
 ...
 'src/main/java/io/spring/|├── api/|│   └── exception/|├── application/|│   ├── ArticleService.java|│   └── UserService.java|└── infrastructure/|    └── mybatis/',
...
('fastapi-realworld', 'nsidnev',
 ...
 'app/|├── api/|│   └── routes/|├── core/|│   └── settings.py|├── db/|│   ├── queries/|│   └── repositories/|└── models/',
...
('nestjs-realworld', 'lujakob',
 ...
 'src/|├── article/|│   ├── article.controller.ts|│   ├── article.service.ts|│   └── article.entity.ts|├── user/|│   └── user.module.ts|└── shared/',
...
('hexagonal-spring', 'thombergs',
 ...
 'src/main/java/|├── account/|│   ├── adapter/|│   │   ├── in/web/|│   │   └── out/persistence/|│   ├── application/|│   │   ├── port/|│   │   └── service/|│   └── domain/',
...
('express-api-starter', 'w3tecch',
 ...
 'src/|├── api/|│   ├── controllers/|│   ├── middlewares/|│   └── services/|├── config/|└── database/',
